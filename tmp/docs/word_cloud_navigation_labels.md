...
Labels selected from the publication tag matrix for the homepage word cloud. Principal topics are pinned first; specific keywords are recurring labels shown below them.

| Role | Label | Publications |
| --- | --- | --- |
| Principal topic | haptics | 37 |
| Principal topic | multisensory perception | 31 |
| Principal topic | extended reality / virtual reality | 27 |
| Principal topic | temporal perception | 27 |
| Principal topic | psychophysics | 25 |
| Principal topic | computational modelling | 23 |
| Specific keyword | vision | 26 |
